...
class CTkColorPicker(customtkinter.CTkFrame):
    ...
    def __init__(self,
        ...
        self.fade_slider_value.set(255)
        ...
        self.entry_label = customtkinter.CTkLabel(self, text="Color in RGB format:", fg_color="transparent", font=("Open Sans", 14))
        self.entry = customtkinter.CTkEntry(self, textvariable=self.text_var ,placeholder_text="#000000", font=("Open Sans", 18), width=130)
        ...
        self.entry_label.grid(row=2, column=1, columnspan=2, padx=(15,0), pady=(20), sticky="nw")
        self.entry.grid(row=2, column=1, columnspan=2, padx=(15,0), pady=(50,0), sticky="nw")
